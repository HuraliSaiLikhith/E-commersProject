...
import com.scaler.demoproject.configs.RedisTemplateConfig;
...
public class FakeStoreProductService implements ProductService{
    ...
    public Product getSingleProduct(Long productId) throws ProductNotFoundException {
        ...
        Product productFromRedis = (Product) redisTemplate.opsForValue().get(productId);;
...
//        redisTemplate.opsForHash().put("PRODUCTS", "PROCUCTS"+productId, fakeStoreProductDto.toProduct());
        redisTemplate.opsForValue().set(productId, fakeStoreProductDto.toProduct(), 30, TimeUnit.MINUTES);
